...
${GOPATH}/bin/defaulter-gen "${ALL_FQ_APIS[@]}" --extra-peer-dirs $(codegen::join , "${ALL_PEERS[@]}") --output-file zz_generated.defaults.go --go-header-file ${SCRIPT_ROOT}/hack/boilerplate.txt --v=8 "$@" || { echo "defaulter-gen failed" >&2 && true; }
